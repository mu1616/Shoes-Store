package com.example.project_01.controller.admin;
	...
	public void upload(HttpServletRequest request, HttpServletResponse response) {
		try { //파일정보 
			...
			if(cnt == 0) { 
				...
				String filePath = File.separator + "smarteditor" + File.separator + "img" + File.separator;
				...
				sFileInfo += "&sFileURL="+"/smarteditor/img/"+realFileNm; 
				PrintWriter print = response.getWriter(); 
